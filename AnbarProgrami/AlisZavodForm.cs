...
{
    public partial class AlisZavodForm : Form
    {
        ...
        public void listelecomboboxworker()
        {
            try
            {
                ...
                baqlanti.Open();
                string query = "select * from IsciTable Where DeleteInfo is not 2";
        ...
        public void selectlistele()
        {
            ...
            try
            {
                ...
                SQLiteCommand kommand = new SQLiteCommand("Select QaimeNomresi, IsciTable.Ad,  NeqliyyatNomresi, QaimeTable.Tarix, QaimeTable.OperationDate, QaimeTable.Qeyd, CAST ( CASE WHEN QaimeTable.EditInfo = 1 THEN 'Redaktə olundu' END AS nvarchar(55)) as EditInfo, CAST ( CASE WHEN QaimeTable.DeleteInfo = 2 THEN 'Silindi' END AS nvarchar(55)) as DeleteInfo, QaimeTable.QaimeID, IsciTable.IsciID From IsciTable join QaimeTable on IsciTable.IsciID = QaimeTable.IsciID Where " + editedsql + " QaimeTable.DeleteInfo " + silinensql + " And QaimeTable.Tarix >=  @Date1 And QaimeTable.Tarix <= @Date2 order by QaimeID desc", baqlanti);
        ...
        private void AlisZavodForm_Load(object sender, EventArgs e)
        {
        ...
        private void deleteBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                int QaimeID = Convert.ToInt32(DGW.GetDataRow(DGW.FocusedRowHandle)[8].ToString());
                ...
                kommand.CommandText = "Update QaimeTable Set DeleteInfo=@DeleteInfo Where QaimeID=@QaimeID";
        ...
        private void addGBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                kommand.Connection = baqlanti;
                baqlanti.Open();
                kommand.CommandText = "Insert Into QaimeTable (QaimeNomresi, IsciID, NeqliyyatNomresi, Tarix, Qeyd, OperationDate) Values (@QaimeNomresi, @IsciID, @NeqliyyatNomresi, @Tarix, @Qeyd, @OperationDate)";
                kommand.Parameters.AddWithValue("@QaimeNomresi", qaimeNumberTxt.Text);
            ...
            try
            {
                ...
                else
                {
                    try
                    {
                        ...
                        kommand.Connection = baqlanti;
                        baqlanti.Open();
                        kommand.CommandText = "Update QaimeTable Set QaimeNomresi=@QaimeNomresi, IsciID=@IsciID, NeqliyyatNomresi=@NeqliyyatNomresi, Tarix=@Tarix, Qeyd=@Qeyd, OperationDate=@OperationDate, EditInfo=@EditInfo Where QaimeID=@QaimeID";
                        kommand.Parameters.AddWithValue("@QaimeID", QaimeID);
                        kommand.Parameters.AddWithValue("@QaimeNomresi", qaimeNumberTxt.Text);
        ...
        {
            editinsozu = " QaimeTable.EditInfo " + editedsql + " And ";
            edited = true;
            selectlistele();
            showEditBtn.Visible = false;
        ...
        private void showFDateBtn_Click(object sender, EventArgs e)
        {
            searchdate1 = search1DTPicker.Text;
            searchdate2 = search2DTPicker.Text;
            selectlistele();
        ...
        private void AlisZavodForm_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }

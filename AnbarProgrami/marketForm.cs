    ...
    public partial class marketForm : Form
    {
        ...
        public void selectlistele()
        {
            try
            {
                ...
                SQLiteCommand kommand = new SQLiteCommand("Select Ad, WeherUnvan, RayonUnvan, QesebeUnvan, TamUnvan, Email, Temsilci, TWexsNomresi, TQeydUnvani, Phone, Tarixi, SifarisciTable.OperationDate, SifarisciTable.Qeyd, CAST ( CASE WHEN SifarisciTable.EditInfo = 1 THEN 'Redaktə olundu' END AS nvarchar(55)) as EditInfo, CAST ( CASE WHEN SifarisciTable.DeleteInfo = 2 THEN 'Silindi' END AS nvarchar(55)) as DeleteInfo, SifarisciID,SifarisciType From  SifarisciTable Where SifarisciType = 1 And " + editedsql + " SifarisciTable.DeleteInfo " + silinensql, baqlanti);
        ...
        private void MarketForm_Load(object sender, EventArgs e)
        {
            ...
            DGW.Columns[0].Caption = "Müəssənin adı";
            DGW.Columns[1].Caption = "Şəhər";
            DGW.Columns[2].Caption = "Rayon";
            DGW.Columns[3].Caption = "Qəsəbə";
            DGW.Columns[4].Caption = "Tam ünvan";
            DGW.Columns[5].Caption = "E-mail";
            DGW.Columns[6].Caption = "Təmsilçisi";
            DGW.Columns[7].Caption = "Təmsilçi Ş/V nömrəsi";
            DGW.Columns[8].Caption = "Təmsilçi Q ünvanı ";
            DGW.Columns[9].Caption = "Telefon nömrəsi";
            DGW.Columns[10].Caption = "Əlavə olunma tarixi";
            DGW.Columns[11].Caption = "Qeyd tarixi";
            DGW.Columns[12].Caption = "Qeyd";
            DGW.Columns[13].Caption = "Redaktə olunan";
            DGW.Columns[14].Caption = "Silinən";
            DGW.Columns[15].Caption = "SifarisciID";
            DGW.Columns[16].Caption = "SifarisciType";
        ...
        private void editBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                factoryMarketNameTxt.Text = DGW.GetDataRow(DGW.FocusedRowHandle)[0].ToString();
                factoryMarketLocationSehTxt.Text = DGW.GetDataRow(DGW.FocusedRowHandle)[1].ToString();
                factoryMarketLocationRayTxt.Text = DGW.GetDataRow(DGW.FocusedRowHandle)[2].ToString();
                factoryMarketLocationQesTxt.Text = DGW.GetDataRow(DGW.FocusedRowHandle)[3].ToString();
                factoryMarketLocationTamTxt.Text = DGW.GetDataRow(DGW.FocusedRowHandle)[4].ToString();
                factoryMarketEmailTxt.Text = DGW.GetDataRow(DGW.FocusedRowHandle)[5].ToString();
                factoryMarketTemsilciTxt.Text = DGW.GetDataRow(DGW.FocusedRowHandle)[6].ToString();
                factoryMarketTemsilciSVNTxt.Text = DGW.GetDataRow(DGW.FocusedRowHandle)[7].ToString();
                factoryMarketTemsilciQUTxt.Text = DGW.GetDataRow(DGW.FocusedRowHandle)[8].ToString();
                factoryMarketPhoneTxt.Text = DGW.GetDataRow(DGW.FocusedRowHandle)[9].ToString();
                string qeydt = DGW.GetDataRow(DGW.FocusedRowHandle)[10].ToString();
                string operationdate = DGW.GetDataRow(DGW.FocusedRowHandle)[11].ToString();
                factoryMarketNoteTxt.Text = DGW.GetDataRow(DGW.FocusedRowHandle)[12].ToString();
                int sifarisciid = Convert.ToInt32(DGW.GetDataRow(DGW.FocusedRowHandle)[15].ToString());
                factoryMarketAddDTPicker.Text = DGW.GetDataRow(DGW.FocusedRowHandle)[14].ToString();

                selectTable = User.name + " " + '"' + this.Text + '"' + " -ndə Köhnə məlumatı: ( Adı: " + factoryMarketNameTxt.Text + " , Şəhər: " + factoryMarketLocationSehTxt.Text + " , Rayon: " + factoryMarketLocationRayTxt.Text + " , Qəsəbə: " + factoryMarketLocationQesTxt.Text + " , Tam ünvanı: " + factoryMarketLocationTamTxt.Text + " , Email: " + factoryMarketEmailTxt.Text + " , Təmsilçi: " + factoryMarketTemsilciTxt.Text + " , Təmsilçi Ş/V nömrəsi: " + factoryMarketTemsilciSVNTxt.Text + " , Təmsilçi Qeyd ünvanı: " + factoryMarketTemsilciQUTxt.Text + " , Telefon nömrəsi: " + factoryMarketPhoneTxt.Text + " , Əlavə olunma tarixi: " + factoryMarketAddDTPicker.Text + " , Qeyd tarixi: " + operationdate + " , Qeyd: " + factoryMarketNoteTxt.Text + " ) -->  Yeni məlumata: ( ";
        ...
        private void deleteBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (cavab == DialogResult.Yes)
                {
                    ...
                    string ad = DGW.GetDataRow(DGW.FocusedRowHandle)[0].ToString();
                    string seher = DGW.GetDataRow(DGW.FocusedRowHandle)[1].ToString();
                    string rayon = DGW.GetDataRow(DGW.FocusedRowHandle)[2].ToString();
                    string qesebe = DGW.GetDataRow(DGW.FocusedRowHandle)[3].ToString();
                    string tamunvan = DGW.GetDataRow(DGW.FocusedRowHandle)[4].ToString();
                    string email = DGW.GetDataRow(DGW.FocusedRowHandle)[5].ToString();
                    string temsilci = DGW.GetDataRow(DGW.FocusedRowHandle)[6].ToString();
                    string temsilciSVNTxt = DGW.GetDataRow(DGW.FocusedRowHandle)[7].ToString();
                    string temsilciQUTxt = DGW.GetDataRow(DGW.FocusedRowHandle)[8].ToString();
                    string phoneTxt = DGW.GetDataRow(DGW.FocusedRowHandle)[9].ToString();
                    string qeydt = DGW.GetDataRow(DGW.FocusedRowHandle)[10].ToString();
                    string addt = DGW.GetDataRow(DGW.FocusedRowHandle)[11].ToString();
                    string noteTxt = DGW.GetDataRow(DGW.FocusedRowHandle)[12].ToString();
                    int sifarisciid = Convert.ToInt32(DGW.GetDataRow(DGW.FocusedRowHandle)[15].ToString());
                    int sifariscitype = Convert.ToInt32(DGW.GetDataRow(DGW.FocusedRowHandle)[16].ToString());
                    ...
                    string DeleteRowLog = User.name + " Sildi: " + '"' + this.Text + '"' + " ində" + "( Adı: " + ad + " , Şəhər: " + seher + " , Rayon: " + rayon + " , Qəsəbə: " + qesebe + " , Tam ünvanı: " + tamunvan + " , Email: " + email + " , Təmsilçi: " + temsilci + " , Təmsilçi Ş/V nömrəsi: " + temsilciSVNTxt + " , Təmsilçi Qeyd ünvanı: " + temsilciQUTxt + " , Telefon nömrəsi: " + phoneTxt + " , Əlavə olunma tarixi: " + qeydt + " , Qeyd tarixi: " + addt + " , Qeyd: " + noteTxt + ")";
            ...
            try
            {
                ...
                else
                {
                    try
                    {
                        ...
                        kommand.Connection = baqlanti;
                        baqlanti.Open();
                        kommand.CommandText = "Insert Into SifarisciTable (Ad, WeherUnvan, RayonUnvan, QesebeUnvan, TamUnvan, Email, Temsilci, TWexsNomresi, TQeydUnvani, Phone, Tarixi, OperationDate, Qeyd, SifarisciType) Values (@Ad, @WeherUnvan, @RayonUnvan, @QesebeUnvan, @TamUnvan, @Email, @Temsilci, @TWexsNomresi, @TQeydUnvani, @Phone, @Tarixi, @OperationDate, @Qeyd, @SifarisciType)";
                        ...
                        kommand.Parameters.AddWithValue("@SifarisciType", 1);
                        kommand.ExecuteNonQuery();
                        baqlanti.Close();
                    }
                    catch (Exception ex)
                    ...
                    try
                    {
                        string addLog = User.name + " " + '"' + this.Text + '"' + " -nə əlavə etdi: ( Adı: " + factoryMarketNameTxt.Text + " , Şəhər: " + factoryMarketLocationSehTxt.Text + " , Rayon: " + factoryMarketLocationRayTxt.Text + " , Qəsəbə: " + factoryMarketLocationQesTxt.Text + " , Tam ünvanı: " + factoryMarketLocationTamTxt.Text + " , Email: " + factoryMarketEmailTxt.Text + " , Təmsilçi: " + factoryMarketTemsilciTxt.Text + " , Təmsilçi Ş/V nömrəsi: " + factoryMarketTemsilciSVNTxt.Text + " , Təmsilçi Qeyd ünvanı: " + factoryMarketTemsilciQUTxt.Text + " , Telefon nömrəsi: " + factoryMarketPhoneTxt.Text + " , Əlavə olunma tarixi: " + factoryMarketAddDTPicker.Text + " , Qeyd tarixi: " + operationdate + " , Qeyd: " + factoryMarketNoteTxt.Text + " )";
                        SQLiteCommand kommand = new SQLiteCommand();
                        kommand.Connection = baqlanti;
                        kommand.CommandText = "Insert Into LogTable (IsciID,OperationDate,OperationType,CommentInfo) Values (@IsciID,@OperationDate,@OperationType,@CommentInfo)";
                        kommand.Parameters.AddWithValue("@IsciID", Convert.ToInt32(User.isciid));
            ...
            try
            {
                ...
                else
                {
                    try
                    {
                        SQLiteCommand kommand = new SQLiteCommand();
                        kommand.Connection = baqlanti;
                        kommand.CommandText = "Update SifarisciTable Set Ad=@Ad, WeherUnvan=@WeherUnvan, RayonUnvan=@RayonUnvan, QesebeUnvan=@QesebeUnvan, TamUnvan=@TamUnvan, Email=@Email, Temsilci=@Temsilci, TWexsNomresi=@TWexsNomresi, TQeydUnvani=@TQeydUnvani, Phone=@Phone, Tarixi=Tarixi, OperationDate=@OperationDate, Qeyd=@Qeyd, EditInfo=@EditInfo Where SifarisciID=@SifarisciID";
                        kommand.Parameters.AddWithValue("@SifarisciID", sifarisciid);
                        kommand.Parameters.AddWithValue("@Ad", factoryMarketNameTxt.Text);
                        kommand.Parameters.AddWithValue("@WeherUnvan", factoryMarketLocationSehTxt.Text);
                        kommand.Parameters.AddWithValue("@RayonUnvan", factoryMarketLocationRayTxt.Text);
                        ...
                        kommand.ExecuteNonQuery();
                        baqlanti.Close();
                        string changetable = " Adı: " + factoryMarketNameTxt.Text + " , Şəhər: " + factoryMarketLocationSehTxt.Text + " , Rayon: " + factoryMarketLocationRayTxt.Text + " , Qəsəbə: " + factoryMarketLocationQesTxt.Text + " , Tam ünvanı: " + factoryMarketLocationTamTxt.Text + " , Email: " + factoryMarketEmailTxt.Text + " , Təmsilçi: " + factoryMarketTemsilciTxt.Text + " , Təmsilçi Ş/V nömrəsi: " + factoryMarketTemsilciSVNTxt.Text + " , Təmsilçi Qeyd ünvanı: " + factoryMarketTemsilciQUTxt.Text + " , Telefon nömrəsi: " + factoryMarketPhoneTxt.Text + " , Əlavə olunma tarixi: " + factoryMarketAddDTPicker.Text + " , Qeyd tarixi: " + operationdate + " , Qeyd: " + factoryMarketNoteTxt.Text + " ) dəyişdi";
                        kommand.CommandText = "Insert Into LogTable (IsciID,OperationDate,OperationType,CommentInfo) Values (@IsciID,@OperationDate,@OperationType,@CommentInfo)";
                        kommand.Parameters.AddWithValue("@IsciID", Convert.ToInt32(User.isciid));
                        kommand.Parameters.AddWithValue("@OperationDate", operationdate);
